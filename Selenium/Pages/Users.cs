...
namespace Selenium
{
    public sealed class Users : Base<Users>
    {
        ...
        public IWebElement New => _driver.FindElement(By.CssSelector("body > div > div.col-md-10.col-md-offset-1.col-sm-12.col-sm-offset-0 > button"));
